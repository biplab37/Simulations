...
# This button will start/stop an animation.
...
# save a small animation
# record(fig, "double_pendulum.mp4", 1:500, framerate = 30) do i
#     next_step!(state, rod, balls, tail, param)
#     next_step!(state2, rod2, balls2, tail2, param)
# end
...
# create functional component for later use
